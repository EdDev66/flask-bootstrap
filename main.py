...
class CafeForm(FlaskForm):
    ...
    wifi_rating = SelectField('Wifi Strength Rating', choices=wifi_choices, validators=[DataRequired()])
...
def add_cafe():
    ...
    if form.validate_on_submit():
        ...
        data.append(close_time)
        data.append(rating)
        data.append(wifi_rating)
        data.append(power_rating)
